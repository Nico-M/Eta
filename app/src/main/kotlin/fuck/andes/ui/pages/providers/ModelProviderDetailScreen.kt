...
internal val ProviderConfigDraftSaver = mapSaver(
    ...
    restore = { saved ->
        ProviderConfigDraft(
            ...
            systemPrompt = saved["systemPrompt"] as? String ?: "",
            isEnabled = saved["isEnabled"] as? Boolean ?: true,
            endpointMode = saved["endpointMode"] as? String ?: "",
            hostedWebSearchEnabled = saved["hostedWebSearchEnabled"] as? Boolean ?: false,
            anthropicVersion = saved["anthropicVersion"] as? String
                ?: AnthropicProviderSetting.DEFAULT_ANTHROPIC_VERSION,
        )
    },
)
